...
function ItemData(_name, _desc, _price, _effect_type, _effect_val, _icon_idx = 0) constructor {
    name = _name;
    description = _desc;
    price = _price;
...
function init_database() {
    ...
    // Healing
    global.item_database.potion = new ItemData("Potion", "Restores 20 HP.", 100, "HEAL", 20, 0);
    global.item_database.super_potion = new ItemData("Super Potion", "Restores 50 HP.", 300, "HEAL", 50, 1);
    global.item_database.hyper_potion = new ItemData("Hyper Potion", "Restores 200 HP.", 800, "HEAL", 200, 2);
    
    // Status (Placeholder logic for now)
    global.item_database.antidote = new ItemData("Antidote", "Cures Poison.", 100, "STATUS", "poison", 3);
    
    // Store Inventory List (Order of items in shop)
    global.store_catalog = [
        global.item_database.potion,
        global.item_database.super_potion,
        global.item_database.hyper_potion,
        global.item_database.antidote
    ];
}
